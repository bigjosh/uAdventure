...
void dump_hash_table(void) {
    ...
    printf("struct HashEntry hash_table[HASH_PRIME]= { \r\n");
        ...
        for (int i = 0; i < HASH_PRIME; i++) {
            ...
            //if (hash_table[i].meaning != 0) {

            printf(" {\"%.6s\" %s , %5.05d }, // %5.5d \n\r", hash_table[i].text, padding+strlen(hash_table[i].text) ,  hash_table[i].meaning, i);

            // Note we have to manually go in and fix the single quote char - not worth doing it programtically.
